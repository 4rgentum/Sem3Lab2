...
int main() {
  ...
  try {
    ...
    std::cout << "Wagon 1 type: " << static_cast<int>(wagon1.getType())
              << std::endl;
    std::cout << "Wagon 2 max capacity: " << wagon2.getMaxCapacity()
              << std::endl;
    std::cout << "Wagon 3 occupied seats: " << wagon3.getOccupiedSeats()
              << std::endl;
    ...
    int occupiedSeats4 = getNum<int>(
        0, maxCapacity4); // Задаем ограничение на количество занятых мест
    ...
    int occupiedSeats5 = getNum<int>(
        0, maxCapacity5); // Задаем ограничение на количество занятых мест
